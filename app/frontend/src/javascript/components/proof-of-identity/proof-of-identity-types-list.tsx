...
const ProofOfIdentityTypesList: React.FC<ProofOfIdentityTypesListProps> = ({ currentUser }) => {
  ...
  const editProofOfIdentityType = (poit: ProofOfIdentityType): any => {
    return (): void => {
  ...
  const destroyProofOfIdentityType = (id: number): any => {
    return (): void => {
  ...
  const setOrderProofOfIdentityType = (orderBy: string): any => {
    return () => {
      let order = orderBy;
